...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ "./node_modules/rrule/node_modules/tslib/tslib.es6.js");
/* harmony import */ var _iterresult__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./iterresult */ "./node_modules/rrule/dist/esm/src/iterresult.js");
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! tslib */ "./node_modules/rrule/node_modules/tslib/tslib.es6.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_rrule__WEBPACK_IMPORTED_MODULE_0__.RRule);
...
/* harmony import */ var _iter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./iter */ "./node_modules/rrule/dist/esm/src/iter/index.js");
/* harmony import */ var _dateutil__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./dateutil */ "./node_modules/rrule/dist/esm/src/dateutil.js");
...
/* harmony import */ var _rrule__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../rrule */ "./node_modules/rrule/dist/esm/src/rrule.js");
    ...
    function S() {
        ...
        switch (ttr.symbol) {
            ...
            case 'weekday(s)':
                ...
                options.byweekday = [
                    _rrule__WEBPACK_IMPORTED_MODULE_1__.RRule.MO,
                    _rrule__WEBPACK_IMPORTED_MODULE_1__.RRule.TU,
                    _rrule__WEBPACK_IMPORTED_MODULE_1__.RRule.WE,
                    _rrule__WEBPACK_IMPORTED_MODULE_1__.RRule.TH,
                    _rrule__WEBPACK_IMPORTED_MODULE_1__.RRule.FR
                ];
                ttr.nextSymbol();
                F();
                break;
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! tslib */ "./node_modules/rrule/node_modules/tslib/tslib.es6.js");
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./types */ "./node_modules/rrule/dist/esm/src/types.js");
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers */ "./node_modules/rrule/dist/esm/src/helpers.js");
/* harmony import */ var _rrule__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./rrule */ "./node_modules/rrule/dist/esm/src/rrule.js");
/* harmony import */ var _dateutil__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./dateutil */ "./node_modules/rrule/dist/esm/src/dateutil.js");
...
function parseOptions(options) {
    ...
    if (!(0,_helpers__WEBPACK_IMPORTED_MODULE_1__.isPresent)(opts.byhour)) {
        opts.byhour =
            opts.freq < _rrule__WEBPACK_IMPORTED_MODULE_2__.RRule.HOURLY ? [opts.dtstart.getUTCHours()] : null;
    }
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! tslib */ "./node_modules/rrule/node_modules/tslib/tslib.es6.js");
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./types */ "./node_modules/rrule/dist/esm/src/types.js");
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! tslib */ "./node_modules/rrule/node_modules/tslib/tslib.es6.js");
/* harmony import */ var _rrule__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./rrule */ "./node_modules/rrule/dist/esm/src/rrule.js");
/* harmony import */ var _rruleset__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./rruleset */ "./node_modules/rrule/dist/esm/src/rruleset.js");
/* harmony import */ var _dateutil__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./dateutil */ "./node_modules/rrule/dist/esm/src/dateutil.js");
...
/* harmony import */ var rrule__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! rrule */ "./node_modules/rrule/dist/esm/src/index.js");
...
jquery__WEBPACK_IMPORTED_MODULE_0__.extend(window, rrule__WEBPACK_IMPORTED_MODULE_4__);
...
var getDay = function (i) { return [
    rrule__WEBPACK_IMPORTED_MODULE_4__.RRule.MO,
    rrule__WEBPACK_IMPORTED_MODULE_4__.RRule.TU,
    rrule__WEBPACK_IMPORTED_MODULE_4__.RRule.WE,
    rrule__WEBPACK_IMPORTED_MODULE_4__.RRule.TH,
    rrule__WEBPACK_IMPORTED_MODULE_4__.RRule.FR,
    rrule__WEBPACK_IMPORTED_MODULE_4__.RRule.SA,
    rrule__WEBPACK_IMPORTED_MODULE_4__.RRule.SU
][i]; };
var makeArray = function (s) {
...
var getOptionsCode = function (options) {
    var days = [
        'RRule.MO',
        'RRule.TU',
        'RRule.WE',
    ...
    var items = Object.keys(options).map(function (k) {
        var v = options[k];
        if (v === null) {
            v = 'null';
        }
        else if (k === 'freq') {
            v = "RRule.".concat(rrule__WEBPACK_IMPORTED_MODULE_4__.RRule.FREQUENCIES[v]);
        }
            ...
            if (Array.isArray(v)) {
                v = v.map(function (wday) {
                    ...
                    var s = days[wday.weekday];
                    if (wday.n) {
                        return s + ".nth(".concat(wday.n, ")");
                    }
                    return s;
                });
            }
            ...
            if (v === rrule__WEBPACK_IMPORTED_MODULE_4__.RRule.MO) {
                return '';
            }
            var w = v;
            v = days[w.weekday];
    ...
    return "{\n  ".concat(items.filter(function (v) { return !!v; }).join(',\n  '), "\n}");
};
var makeRows = function (dates, tzid) {
    var rows = dates.map(function (date, index) {
        var dayjsDate = dayjs__WEBPACK_IMPORTED_MODULE_1___default()(date);
        var dateStr = tzid ? dayjsDate.tz(tzid).format() : dayjsDate.format();
        return "<tr><td>".concat(index + 1, "</td><td>").concat(dateStr, "</td></tr>");
    });
    return rows.join('\n\n');
};
jquery__WEBPACK_IMPORTED_MODULE_0__(function () {
    var $tabs = jquery__WEBPACK_IMPORTED_MODULE_0__('#tabs');
    var activateTab = function ($a) {
        var id = $a.attr('href').split('#')[1];
        $tabs.find('a').removeClass('active');
        $a.addClass('active');
        jquery__WEBPACK_IMPORTED_MODULE_0__('#input-types section').hide();
        return jquery__WEBPACK_IMPORTED_MODULE_0__("#input-types #".concat(id))
            .show()
            .find('input:first')
            .trigger('focus')
            .trigger('change');
    };
    jquery__WEBPACK_IMPORTED_MODULE_0__('#input-types section')
        .hide()
        .each(function () {
        jquery__WEBPACK_IMPORTED_MODULE_0__('<a />', {
            href: "#".concat(jquery__WEBPACK_IMPORTED_MODULE_0__(this).attr('id'))
        })
            .text(jquery__WEBPACK_IMPORTED_MODULE_0__(this)
            .find('h3')
            .hide()
            .text())
            .appendTo($tabs)
            .on('click', function () {
            activateTab(jquery__WEBPACK_IMPORTED_MODULE_0__(this));
            return false;
        });
    });
    jquery__WEBPACK_IMPORTED_MODULE_0__('.examples code').on('click', function () {
        var $code = jquery__WEBPACK_IMPORTED_MODULE_0__(this);
        var $section = $code.parents('section:first');
    ...
    var init;
    var makeRule;
    jquery__WEBPACK_IMPORTED_MODULE_0__('input, select, textarea').on('keyup change', function () {
        var $in = jquery__WEBPACK_IMPORTED_MODULE_0__(this);
        var $section = $in.parents('section:first');
        var inputMethod = $section.attr('id').split('-')[0];
        switch (inputMethod) {
            case 'text':
                makeRule = function () { return rrule__WEBPACK_IMPORTED_MODULE_4__.RRule.fromText($in.val().toString()); };
                init = "RRule.fromText(\"".concat(this.value, "\")");
                break;
            case 'rfc':
                var value_1 = (this.value).replace(/\\n/g, '\n').replace(/\\r/g, '\r');
                $in.val(value_1);
                makeRule = function () { return rrule__WEBPACK_IMPORTED_MODULE_4__.RRule.fromString(value_1); };
                init = "RRule.fromString(\"".concat(this.value, "\")");
                break;
            case 'options':
                ...
                for (var k in values) {
                    ...
                    switch (key) {
                        case 'dtstart':
                        case 'until':
                            var date = new Date(Date.parse(value_2 + 'Z'));
                            options_1[key] = date;
                            continue;
                        case 'byweekday':
                            if (Array.isArray(value_2)) {
                                options_1[key] = value_2.map(function (i) { return getDay(parseInt(i, 10)); });
                            }
                            else {
                                options_1[key] = getDay(parseInt(value_2, 10));
                            }
                            continue;
                        case 'wkst':
                            options_1[key] = getDay(parseInt(value_2, 10));
                        ...
                        case 'bynmonthday':
                            if (!Array.isArray(value_2)) {
                                value_2 = value_2.split(/[,\s]+/);
                            }
                            value_2 = value_2.filter(function (v) { return v; });
                            options_1[key] = value_2.map(function (n) { return parseInt(n, 10); });
                            continue;
                        case 'bynweekday':
                            if (!Array.isArray(value_2)) {
                                value_2 = value_2.split(/[,\s]+/);
                            ...
                            continue;
                        case 'byeaster':
                            options_1[key] = parseInt(value_2, 10);
                            continue;
                        case 'freq':
                        case 'count':
                            options_1[key] = parseInt(value_2, 10);
                ...
                makeRule = function () { return new rrule__WEBPACK_IMPORTED_MODULE_4__.RRule(options_1); };
                init = "new RRule(".concat(getOptionsCode(options_1), ")");
                console.log(options_1);
                break;
        }
        jquery__WEBPACK_IMPORTED_MODULE_0__('#init').html(init);
        jquery__WEBPACK_IMPORTED_MODULE_0__('#rfc-output a').html('');
        jquery__WEBPACK_IMPORTED_MODULE_0__('#text-output a').html('');
        jquery__WEBPACK_IMPORTED_MODULE_0__('#options-output').html('');
        jquery__WEBPACK_IMPORTED_MODULE_0__('#dates').html('');
        var rule;
        try {
            rule = makeRule();
        }
        catch (e) {
            jquery__WEBPACK_IMPORTED_MODULE_0__('#init').append(jquery__WEBPACK_IMPORTED_MODULE_0__('<pre class="error"/>').text("=> ".concat(String(e || null))));
            return;
        }
        var rfc = rule.toString();
        var text = rule.toText();
        jquery__WEBPACK_IMPORTED_MODULE_0__('#rfc-output a')
            .text(rfc)
            .attr('href', "#/rfc/".concat(encodeURIComponent(rfc)));
        jquery__WEBPACK_IMPORTED_MODULE_0__('#text-output a')
            .text(text)
            .attr('href', "#/text/".concat(encodeURIComponent(text)));
        jquery__WEBPACK_IMPORTED_MODULE_0__('#options-output').text(getOptionsCode(rule.origOptions));
        if (inputMethod === 'options') {
            jquery__WEBPACK_IMPORTED_MODULE_0__('#options-output')
                .parents('tr')
                .hide();
        }
        else {
        ...
        var max = 500;
        var dates = rule.all(function (date, i) {
            if (!rule.options.count && i === max) {
                return false; // That's enough
            }
            return true;
        });
        var html = makeRows(dates, rule.options.tzid);
        if (!rule.options.count) {
            html += "<tr><td colspan='7'><em>Showing first ".concat(max, " dates, set\n<code>count</code> to see more.</em></td></tr>");
        }
        return jquery__WEBPACK_IMPORTED_MODULE_0__('#dates').html(html);
    });
    activateTab($tabs.find('a:first'));
    var processHash = function () {
        var hash = location.hash.substring(1);
        if (hash) {
            var match = /^\/(rfc|text)\/(.+)$/.exec(hash);
            if (match) {
                var method = match[1]; // rfc | text
                var arg = decodeURIComponent(match[2]);
                activateTab(jquery__WEBPACK_IMPORTED_MODULE_0__("a[href='#".concat(method, "-input']")));
                if (method === 'rfc') {
                    return jquery__WEBPACK_IMPORTED_MODULE_0__("#".concat(method, "-input textarea:first"))
                        .val(arg)
                        .trigger('change');
                }
                else {
                    return jquery__WEBPACK_IMPORTED_MODULE_0__("#".concat(method, "-input input:first"))
                        .val(arg)
                        .trigger('change');
                }
            }
    ...
    processHash();
    return jquery__WEBPACK_IMPORTED_MODULE_0__(window).on('hashchange', processHash);
});
